...
export function getLocaleLabel(locale) {
  const labels = {
    ...
    fr: t('settings.admin.emailTemplates.locales.fr', 'Français'),
    es: t('settings.admin.emailTemplates.locales.es', 'Español'),
    pt: t('settings.admin.emailTemplates.locales.pt', 'Português'),
