/**
 * Recipe: the ordinary editor on the KPI slide — thumbnails, canvas and inspector, no modal (nl).
 * Registry id: marketing-editor-canvas-nl → public/images/marketing/editor-canvas-nl.png
...
export default editorCanvasShot('nl');
