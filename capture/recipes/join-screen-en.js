/**
 * Recipe: the follow-along invite on the big screen — QR, short URL, access code (en).
 * Registry id: shot-join-screen-en → public/images/marketing/join-screen-en.png
...
export default joinScreenShot('en');
