 ...
 * behavior-preserving) and gates the bare-Error idiom out of the three trees.
 * What an upstream Notion failure answers is pinned in
 * `notion-upstream-error.test.js` (B416).
 *
