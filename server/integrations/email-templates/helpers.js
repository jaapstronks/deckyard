...
export const EMAIL_STYLES = {
  ...
  button:
    'display: inline-block; background-color: #0066cc; color: white; padding: 12px 24px; text-decoration: none; border-radius: 4px; font-weight: 500;',
  buttonAlt:
  ...
  blockquote:
    'border-left: 3px solid #ccc; padding-left: 12px; margin: 16px 0; color: #555;',
};
