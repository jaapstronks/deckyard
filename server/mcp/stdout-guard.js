 ...
 * the connection. Deckyard modules log status with `console.log` — storage
 * announces its adapter, for one — so every `console.log` in this process has
 * to land on stderr instead. (The slide-type registry and custom loader used
 * to be the other offenders; they write to stderr themselves now.)
 *
