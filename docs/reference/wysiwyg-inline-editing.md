...
| `cards.skipWhenEmpty`                                          | Dual-model guard: no card affordances while the array is empty, so add/remove never grows an array on a deck the renderer still reads from legacy numbered fields. Only text-blocks still needs it — the other numbered families went with schema v7 -> v8.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
- `skipWhenEmpty` is load-bearing for text-blocks, the last type with a
