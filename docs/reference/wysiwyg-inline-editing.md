...
| `video-slide`          | `title`                                                                                                  | `title`                                                                                                    | –                             | `transcript`            | –                                                                           |
...
| `text-blocks-slide`    | `title`, `subheading`, `bottomSubheading`                                                                | `title`, `subheading`, `bottomSubheading`, `rows.title`                                                    | `rows` (two-level → `blocks`) | `rows.blocks.body`      | –                                                                           |
