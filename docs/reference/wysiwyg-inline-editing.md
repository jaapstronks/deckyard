...
| `itemGhosts[]`                                                 | Ghosts for optional per-item subfields the renderer omits when empty: `{ list, field, item, within?, chipAnchor?, pos?, chip? }`. `item` is the item-element selector (elements carry `data-inline-item-index`); `within` an inner element to spawn into.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
