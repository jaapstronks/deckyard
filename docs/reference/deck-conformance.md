...
Until this page, the only available answer was "all of it" — <!--gen:slide-type-count-->33<!--/gen:slide-type-count--> slide types,
...
Neither level requires all <!--gen:slide-type-count-->33<!--/gen:slide-type-count--> types. Tier 2 is not a conformance surface: we
