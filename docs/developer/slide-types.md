...
| `markdown` | Multi-line rich text (renders to HTML; **HTML is escaped**). `headingKey` names a sibling string that heads this block in the reflowable projection, as an `<h3>` (a `<p>` when the block is empty), consumed there.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | `maxLength`, `required`, `headingKey`                                                                                     |
