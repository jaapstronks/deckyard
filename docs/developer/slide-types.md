...
- **Warnings** leave the type registered but say what is being ignored: a field
  ...
  `mediaRef`, `foldUnofferedTo`, `itemLabelField`, `orderedWhen` or `rowHeader`
  on a field type that cannot honour it, a field
