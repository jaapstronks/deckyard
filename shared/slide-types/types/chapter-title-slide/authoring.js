/**
 * chapter-title-slide — the authoring companions.
 *
...
export default {
   ...
   */
  description: 'Section divider between topics',

  /**
   * Extra search terms (incl. Dutch) folded into the picker's search haystack.
   * Never displayed.
   */
  aliases: 'section divider hoofdstuk tussentitel',
