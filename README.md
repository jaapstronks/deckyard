...
**For presenters:** <!--gen:slide-type-count-->36<!--/gen:slide-type-count--> typed slide types, live presenting with speaker notes, audience follow-along with polls and Q&A, a UI in 12 languages, and an AI wizard that actually understands presentation design.
...
|---|---|---|---|
| AI generation | ✅ | ✅ | ✅ <!--gen:slide-type-count-->36<!--/gen:slide-type-count--> typed slides |
...
- `convert_slide` — Switch between <!--gen:slide-type-count-->36<!--/gen:slide-type-count--> slide types with AI-powered content adaptation
...
1. **Outlines** the deck structure, picking from <!--gen:slide-type-count-->36<!--/gen:slide-type-count--> typed slide layouts
